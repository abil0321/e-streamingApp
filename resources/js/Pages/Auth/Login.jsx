...
export default function Login() {
    ...
    // NOTE: Menggunakan useForm untuk mengelola state form
    ...
    // NOTE: Fungsi untuk mengirim data login
    const submit = (e) => {
        e.preventDefault();
                                    ...
                                    >
                                        ...
                                        <div className="relative">
                                            ...
                                            <button
                                                ...
                                                className="absolute right-4 top-1/2 md:top-2/4 transform-translate-y-1/2 text-gray-500 hover:text-gray-700"
                                            >
                                                <EyeIcon
